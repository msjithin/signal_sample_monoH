...
# with command line options: Configuration/GenProduction/python/monoHiggsTauTau_fragment.py --fileout file:monoHtautau_18GS.root --mc --eventcontent RAWSIM --datatier GEN-SIM --conditions 102X_upgrade2018_realistic_v20 --beamspot Realistic25ns13TeVEarly2018Collision --step GEN,SIM --geometry DB:Extended --era Run2_2018 --python_filename monoHtautau_18GS_cfg.py --no_exec --customise Configuration/DataProcessing/Utils.addMonitoring --customise_commands process.source.numberEventsInLuminosityBlock=cms.untracked.uint32(1408450) -n 100
...
process.RAWSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:monoHtautau_18GS.root'),
...
process.LHEoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:inLHE_monoHiggstautau_18GS.root'),
