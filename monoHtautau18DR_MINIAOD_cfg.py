...
# with command line options: step1 --filein file:monoHtautau18DR_step2.root --fileout file:monoHtautau18DR_MINIAOD.root --mc --eventcontent MINIAODSIM --runUnscheduled --datatier MINIAODSIM --conditions 102X_upgrade2018_realistic_v20 --step PAT --nThreads 8 --geometry DB:Extended --era Run2_2018 --python_filename monoHtautau18DR_MINIAOD_cfg.py --no_exec --customise Configuration/DataProcessing/Utils.addMonitoring -n 100
...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring('file:monoHtautau18DR_step2.root'),
...
process.MINIAODSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:monoHtautau18DR_MINIAOD.root'),
